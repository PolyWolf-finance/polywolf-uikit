...
var getThemeTextColor = function (_a) {
    ...
    return outline ? getColor(variant, theme) : "#404040";
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 410 52" }, props),
        React.createElement("image", { width: "410", height: "52", href: isDark ? "/images/egg/LogoTextNewDark.png" : "/images/egg/LogoTextNewWhite.png" })));
};
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://explorer-mainnet.maticvigil.com/address/" + account, mr: "16px" }, "View on Matic chain"),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "primary", onClick: function () {
        ...
        } }, accountEllipsis)) : (React.createElement(Button, { size: "sm", variant: "primary", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputBorder: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#ffffff", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9f1fd", background: "#1f2b46", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#0a0e17", input: "#483f3b", inputBorder: "#cccccc", primaryDark: "#d95b00", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#ffffff", borderColor: "#524B63", card: "#121827", gradients: {
